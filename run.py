...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_source', default='2016', type=str)
    parser.add_argument('--data_category', default='Laptops', type=str)
    ...
    parser.add_argument('--mlp_d', default='100', type=int)
    parser.add_argument('--attn_hops', default='50', type=int)
